...
int main(int argc, char* argv[]) {
	...
	if(WINDOW_WIDTH > 1980){
		WINDOW_HEIGHT = 1024;
		WINDOW_WIDTH = 780;
		screen = SDL_SetVideoMode(WINDOW_WIDTH, WINDOW_HEIGHT, 32, SDL_HWSURFACE | SDL_RESIZABLE | SDL_DOUBLEBUF );
		fullscreen = false;
	} else {
		screen = SDL_SetVideoMode(WINDOW_WIDTH, WINDOW_HEIGHT, 32, SDL_HWSURFACE | SDL_FULLSCREEN | SDL_DOUBLEBUF );
	}
